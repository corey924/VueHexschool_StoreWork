      ...
      <tbody>
        <tr v-for="(item) in products" :key="item.id">
          ...
          <td>
            ...
            <button class="class btn btn-outline-danger btn-sm" @click="openModal('delete', item)">刪除</button>
          </td>
        </tr>
      </tbody>
    </table>
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="image" 
                   v-model="tempProduct.imagerUrl" placeholder="請輸入圖片連結">
                </div>
                <div class="form-group">
        ...
        <div class="modal-content border-0">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-danger"
             @click="updateProduct">確認刪除</button>
          </div>
        </div>
      </div>
    </div>
